  ...
  const texte = {
    3.1: {
      car_mf: {
        ...
        paragraph: `<strong>${prozent}&thinsp;%</strong> der Menschen in deiner Region haben ein ähnliches Reiseverhalten wie du mit <strong>${distance}&thinsp;km </strong> mit dem <strong>${translations[travelType]}.</strong> <strong>${distance}&thinsp;km </strong> <span class="addition">(Hin- & Rückweg)</span> entspricht dem hier angezeigten Kreis um deine Postleitzahl.`,
      },
      ecar: {
        travelType: 'car',
        title: 'Dein Mobilitätsprofil',
      ...
      public: {
        travelType: 'public',
        title: 'Dein Mobilitätsprofil',
        paragraph: `<strong>${prozent}&thinsp;%</strong> der Menschen in deiner Region haben ein ähnliches Reiseverhalten wie du mit <strong>${distance}&thinsp;km </strong>mit dem <strong>${translations[travelType]}.</strong> <strong>${distance}</strong>&thinsp;km <span class="addition">(Hin- & Rückweg)</span> entspricht dem hier angezeigten Kreis um deine Postleitzahl.`,
      },
    },
    3.2: {
      car_mf: {
